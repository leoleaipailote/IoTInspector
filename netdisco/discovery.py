...
class NetworkDiscovery:
    ...
    def discover(self):
        ...
        print("discover(self): ", [dis for dis, checker in self.discoverables.items()
                if checker.is_discovered()])
        print("items in self.discoverables.items()", self.discoverables.items())
        tester = []
        for dis, checker in self.discoverables.items():
            print("dis: ", dis)
            print("checker: ", checker)
            print(type(checker));
            #print(checker.)
            if checker.is_discovered():
                print("checker is discovered", dis)
                tester.append(dis)
        print("tester: " , tester)
    ...
    def _load_device_support(self):
        ...
        print("test _load_device_support")
        self.discoverables = {}
