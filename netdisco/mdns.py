...
class FastServiceBrowser(ServiceBrowser):
    ...
    print("instance of FastServiceBrowser being created")
...
class MDNS:
    ...
    def __init__(self, zeroconf_instance=None):
        ...
        print("mdns constructor -> mdns.py")
    ...
    def unregister_type(self, type_):
        ...
        print("test unregister_type -> mdns.py")
        removes = []
    ...
    def start(self):
        ...
        try:
            ...
            for service in self.services:
                print("service", service, " in self.services")
            ...
            def _service_update(zeroconf, service_type, name, state_change):
                ...
                print("a service update was made -> mdns.start._service_update")
            #print(services_by_type)
